...
func _refresh_context() -> void:
	...
	var verbs := {"enter":"Enter workshop","exit":"Leave workshop","wood":"Collect wood bundle","tool":"Take wood axe","bench":"Prepare wood","trade":"Exchange with carpenter"}
	if context_selection.kind in verbs: actions.append({"id":"workshop","label":verbs[context_selection.kind],"enabled":online and not paused})
...
func _choose_context(action: String) -> void:
	...
	match action:
		...
		"inspect":
			var descriptions := {"enter":"Carpenter's workshop. Walk to the door to enter.","wood":"Six pieces of oak wood set aside for your commission.","tool":"An axe for preparing wood. Taking it reveals your hand equipment slot.","bench":"Equip the axe and bring six wood here to prepare them.","trade":"The carpenter exchanges your prepared wood for five coins and a copper ring.","exit":"Return to the West farms."}
