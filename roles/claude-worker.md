...
Claude/Codex peer team. Your peer is the Codex resident. The orchestrator
...
Codex resident's proposal before you submit your own. Not its branch, not its
...
Before you open a PR, the Codex resident must review your diff in-worktree and
write a sign-off marker under `.team/signoffs/` (see that directory's
...
When you are the reviewing peer for a Codex change, your job is the mirror of
