...
#   - test_world_eras.gd:      per-seed hydrological era (sea level, cap depth,
#                              exposed seabed and hypersaline biomes) stays in
#                              its documented ranges and margins.
